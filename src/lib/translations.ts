export const translations = {
  hi: {
    meta: {
      title: "बोलो राधे राधे | एक भक्ति, एक जागरण",
      description:
        "बोलो राधे राधे — गौ माता, किसान और गांव की एक पवित्र सिनेमाई गाथा। जल्द ही आपके सिनेमाघरों में।",
    },
    nav: {
      home: "होम",
      about: "फ़िल्म के बारे में",
      bhakti: "भक्ति",
      gauMata: "गौ माता",
      media: "मीडिया",
      supporters: "समर्थक",
    ...
    hero: {
      ...
      title2: "राधे राधे",
      tagline: [
        "यह सिर्फ एक फ़िल्म नहीं,",
        "एक अभियान है,",
        "सांस्कृतिक गौरव का",
        "राष्ट्र-पुनरुत्थान का",
        "अपरिमित भक्ति का",
        "सरल शब्दों में,",
        "सनातन-सत्य को समर्पित एक विनम्र प्रयास है..",
      ],
      directorLabel: "लेखक एवं निर्देशक",
      directorName: "रवि भाटिया",
    ...
    features: [
      ...
      { title: "किसान", desc: "अन्नदाता का सम्मान, राष्ट्र की पहचान" },
      { title: "गांव", desc: "हमारी जड़ें, हमारी पहचान" },
      { title: "भक्ति", desc: "राधे राधे नाम से जीवन हो पावन" },
    ],
    about: {
      eyebrow: "फ़िल्म के बारे में",
      title: "एक पवित्र कहानी, हर दिल के लिए",
      paragraphs: [
    ...
    notify: {
      ...
      formSubmit: "सूचित करें",
      formSubmitting: "भेजा जा रहा है...",
      formSuccess: "धन्यवाद! हमारी टीम जल्द आपसे संपर्क करेगी।",
      disclaimer: "हम आपकी जानकारी सुरक्षित रखते हैं और केवल फ़िल्म अपडेट के लिए उपयोग करते हैं।",
      errorName: "कृपया अपना नाम दर्ज करें।",
      errorMobile: "कृपया मान्य 10 अंकों का मोबाइल नंबर दर्ज करें।",
    ...
    join: {
      ...
      description:
        "आप सभी से प्रार्थना है कि आप अपने मित्रों, रिश्तेदारों, शुभचिंतकों को इस फ़िल्म से जोड़कर पुण्य के भागी बनें।",
      cta: "अभी जुड़ें",
      followUs: "हमें फॉलो करें",
      formTitle: "फ़िल्म से जुड़ने के लिए संपर्क करें",
      formName: "आपका नाम",
      formLocation: "शहर / देश",
      formPhone: "मोबाइल / व्हाट्सएप",
      formEmail: "ईमेल",
      formSubmit: "सबमिट करें",
      formSuccess: "🙏 धन्यवाद! हम शीघ्र आपसे संपर्क करेंगे।",
    },
    news: {
      title: "समाचार से जुड़े रहिए",
      description:
        "रिलीज़ की तारीख, ट्रेलर और विशेष अपडेट सबसे पहले पाने के लिए अपना ईमेल दर्ज करें।",
    ...
    merchPage: {
      ...
      upiValue: "rave.media@ybl",
      instructions:
        "क्यूआर कोड स्कैन करके या यूपीआई आईडी से भुगतान करें, फिर भुगतान का स्क्रीनशॉट नीचे दिए गए व्हाट्सएप नंबर पर भेजें — आपका ऑर्डर कन्फ़र्म कर दिया जाएगा।",
      whatsappLabel: "व्हाट्सएप नंबर",
      whatsappCta: "व्हाट्सएप पर स्क्रीनशॉट भेजें",
      note: "भुगतान केवल ऊपर दिए गए आधिकारिक क्यूआर कोड या यूपीआई आईडी पर ही करें।",
      close: "बंद करें",
    },
    supportersPage: {
      eyebrow: "आभार",
    ...
    sponsorsPage: {
      ...
      categories: {
        spiritual: "आध्यात्मिक एवं भक्ति साझेदार",
        supporters: "हमारे समर्थक",
        social: "सामाजिक संगठन",
        media: "प्रिंट व डिजिटल मीडिया",
        distribution: "वितरण प्लेटफ़ॉर्म",
        prPublicity: "पीआर व प्रचार",
        outdoorMedia: "आउटडोर मीडिया",
        devotionalTv: "भक्ति टेलीविज़न चैनल - मीडिया प्लान",
    ...
    donatePage: {
      ...
      description:
        "आपका हर योगदान इस सनातनी फ़िल्म के निर्माण और इस भक्ति अभियान को आगे बढ़ाने में सीधे उपयोग होता है।",
      qrCaption: "भुगतान के लिए स्कैन करें",
      qrDemoLabel: "आधिकारिक भुगतान क्यूआर कोड",
      upiLabel: "यूपीआई आईडी",
      upiValue: "rave.media@ybl",
    ...
    footer: {
      ...
      centerLine: "राधे राधे नाम ही जीवन का सार है।",
      comingSoon1: "20 अगस्त 2027",
      comingSoon2: "आपके सिनेमाघरों में",
  ...
  en: {
    meta: {
      title: "Bolo Radhe Radhe | A Devotion, An Awakening",
      description:
        "Bolo Radhe Radhe — a sacred cinematic saga of Gau Mata, the farmer, and the village. Coming soon to theatres.",
    },
    nav: {
      home: "Home",
      about: "About Film",
    ...
    hero: {
      ...
      tagline: [
        ...
        "it's a movement —",
        "of cultural pride,",
        "of a nation's reawakening,",
        "of boundless devotion.",
        "In simple words,",
        "a humble offering dedicated to the eternal truth of Sanatan.",
      ],
      directorLabel: "Writer & Director",
      directorName: "Ravi Bhatia",
    ...
    features: [
      ...
      { title: "The Farmer", desc: "Honouring the nation's provider" },
      { title: "The Village", desc: "Our roots, our identity" },
      { title: "Devotion", desc: "A life made sacred by Radhe Radhe" },
    ],
    about: {
      eyebrow: "About the Film",
      title: "A Sacred Story, For Every Heart",
      paragraphs: [
        "This film is the sacred story of Gau Mata, a farmer, and a village — with Gau Mata at the very heart of it.",
        "Gau Mata fills life with peace, joy, and devotion — and that is the essence of this film's message.",
      ],
      moreLink: "Learn More",
    ...
    story: {
      ...
      chapters: [
        ...
        {
          number: "02",
          title: "The Village Calls",
          description:
            "In present-day India, the story of a farming family and a village woven around service, devotion, and struggle for Gau Mata.",
        },
        {
          number: "03",
          title: "The Awakening",
    ...
    multilingualChant: {
      ...
      introducingLabel: "Introducing Russian Star",
    },
    significance: {
      eyebrow: "Gau Mata",
      title: "Why Gau Mata Is Revered",
      intro:
        "In Indian culture, Gau Mata is regarded not merely as an animal, but as the nurturing mother of all creation.",
      cards: [
        {
          title: "Kamadhenu",
          description:
        ...
        },
        {
          ...
          description:
            "Gau Mata is seen as an embodiment of the Earth herself — patient, giving, and selfless in nourishing all beings.",
        },
        {
          title: "Ahimsa & Compassion",
          description:
            "Protecting the cow stands as one of Indian philosophy's greatest symbols of non-violence, compassion, and reverence for all life.",
        },
        {
          title: "Panchgavya",
          description:
            "Milk, curd, ghee, urine, and dung — the five sacred offerings used in Ayurveda and ritual worship for centuries.",
        },
        {
          title: "Gau Seva",
          description:
            "Service to the cow is regarded as one of the highest virtuous acts in Indian tradition — rooted in care, protection, and respect.",
        },
        {
          title: "Krishna & the Cowherds",
          description:
    ...
    missionVision: {
      ...
      vision: {
        ...
        paragraphs: [
          ...
          "For the first time in Hindi cinema, Gau Mata is being made not just an animal, but the central character of the entire story.",
          "Through the life journey of one Gau Mata, this story connects everyone who shares a direct or indirect bond with the cow.",
          "Such authentic, value-rooted films are not made every day.",
          "“Bolo Radhe Radhe” is not just a film, but an effort toward cultural awakening.",
          "Our goal is not mere commercial success, but the spread of positive consciousness in society.",
          "We seek your guidance and blessings, and would be glad to present a detailed showcase of the film whenever given the opportunity.",
        ],
      },
    },
    message: {
    ...
    notify: {
      ...
      disclaimer: "We keep your information safe and use it only for film updates.",
    ...
    join: {
      ...
      description:
        "We request all of you to share this film with your friends, family, and well-wishers, and be part of this act of devotion.",
      cta: "Join Now",
      followUs: "Follow Us",
      formTitle: "Get in Touch to Join the Film",
      formName: "Your Name",
      formLocation: "City / Country",
      formPhone: "Mobile / WhatsApp",
      formEmail: "Email",
      formSubmit: "Submit",
      formSuccess: "🙏 Thank you! We'll be in touch with you soon.",
    },
    news: {
      title: "Stay Connected",
      description:
        "Enter your email to be the first to know about the release date, trailer, and exclusive updates.",
    ...
    merchPage: {
      ...
      upiValue: "rave.media@ybl",
      instructions:
        "Scan the QR code or pay via the UPI ID, then send a screenshot of the payment to the WhatsApp number below — your order will be confirmed.",
    ...
    sponsorsPage: {
      title: "Our Sponsors",
      categories: {
        spiritual: "Spiritual & Devotional Partners",
        supporters: "Our Supporters",
        social: "Social Associations",
        media: "Print & Digital Media",
        distribution: "Distribution Platforms",
        prPublicity: "PR & Publicity",
        outdoorMedia: "Outdoor Media",
        devotionalTv: "Devotional Television Channel - Media Plan",
    ...
    footer: {
      ...
      tagline: "A Film... A Feeling... A Devotion...",
      centerLine: "The name Radhe Radhe is the essence of life itself.",
      comingSoon1: "20 August 2027",
      comingSoon2: "In Theatres Near You",
